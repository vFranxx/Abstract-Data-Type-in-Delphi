...
// Crea el arbol vacio
Function ArbolBmejorado.Crear(avTipoClave: TipoDatosClave; alSize: LongInt): Errores;
Begin
...
Function ArbolBmejorado.LLenarClavesRandom(alSize: LongInt; RangoDesde, RangoHasta: LongInt): Errores;
Var X: TipoElemento;
I: LongInt;
Begin
  Try
