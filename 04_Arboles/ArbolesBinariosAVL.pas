...
Var H: Integer;
  ...
  If C > H Then H := C; // cada vez que llega a la hoja pregunta si la cantidad de pasos fue mayor que la de la hoja anterior
  End
  Else Begin
    Alt(P^.HI, C + 1);
    Alt(P^.HD, C + 1);
...
Function ArbolAVL.LlenarClavesRandom(alSize: LongInt; RangoDesde, RangoHasta: LongInt): Errores;
Var X: TipoElemento;
Begin
